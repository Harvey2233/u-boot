...
#define CLK_DIV_CPU1_VAL	((CORES_RATIO << 8) | (HPM_RATIO << 4) | (COPY_RATIO << 0))
...
#define CLK_SRC_LEFTBUS_VAL	((MUX_GDL_SEL_SCLKMPLL << 0)	\
				| (MUX_MPLL_USER_SEL_L_FOUTMPLL << 4))

/* CLK_DIV_LEFTBUS */
#define GPL_RATIO		0x1
#define GDL_RATIO		0x3
#define CLK_DIV_LEFTBUS_VAL	((GPL_RATIO << 4) | (GDL_RATIO << 0))
...
#define CLK_SRC_RIGHTBUS_VAL	((MUX_GDR_SEL_SCLKMPLL << 0)	\
				| (MUX_MPLL_USER_SEL_R_FOUTMPLL << 4))

/* CLK_DIV_RIGHTBUS */
#define GPR_RATIO		0x1
#define GDR_RATIO		0x3
#define CLK_DIV_RIGHTBUS_VAL	((GPR_RATIO << 4) | (GDR_RATIO << 0))

/* CLK_SRS_FSYS: 6 = SCLKMPLL */
#define MIPIHSI_SEL_SCLKMPLL_USER_T 0x0
#define MIPIHSI_SEL_SCLKAPLL 0x1
...
#define XXTI	0
#define XusbXTI	1
#define SCLK_HDMI24M 2
#define SCLK_USBPHY0 3
#define SCLK_HDMIPHY 5
#define SCLKMPLL 6
#define SCLKEPLL 7
#define SCLKVPLL 8

#define CAM0_SEL	XusbXTI
#define CAM1_SEL	XusbXTI
#define CSIS0_SEL	XusbXTI
#define CSIS1_SEL	XusbXTI

#define FIMC_SEL_SCLKMPLL	SCLKMPLL
...
/* SCLK MFC */
/* CLK_SRC_MFC */
#define MFC_0_SEL_SCLKMPLL 	0x0
#define MFC_0_SEL_SCLKAPLL 	0x1
#define MFC_1_SEL_SCLKEPLL 	0x0
#define MFC_1_SEL_SCLKVPLL 	0x1
#define MFC_SEL_MOUTMFC_0  	0x0
#define MFC_SEL_MOUTMFC_1	0x1

#define MFC_SEL			MFC_SEL_MOUTMFC_0
#define MFC_1_SEL		MFC_1_SEL_SCLKEPLL
#define MFC_0_SEL		MFC_0_SEL_SCLKMPLL
#define CLK_SRC_MFC_VAL		((MFC_SEL << 8) | (MFC_1_SEL << 4) | (MFC_0_SEL << 0))
...
/* SCLK G3D */
/* CLK_SRC_G3D */
#define G3D_0_SEL_SCLKMPLL	0x0
#define G3D_0_SEL_SCLKAPLL	0x1
#define G3D_1_SEL_SCLKEPLL	0x0
#define G3D_1_SEL_SCLKVPLL	0x1
#define G3D_SEL_MOUTG3D_0	0x0
#define G3D_SEL_MOUTG3D_1	0x1

#define G3D_SEL			G3D_SEL_MOUTG3D_0
#define G3D_1_SEL		G3D_1_SEL_SCLKEPLL
#define G3D_0_SEL		G3D_0_SEL_SCLKMPLL
#define CLK_SRC_G3D_VAL		((G3D_SEL << 8) | (G3D_1_SEL << 4) | (G3D_0_SEL << 0))
...
#define APB_SFR_INTERLEAVE_CONF_VAL     0x80000010
#endif
...
#define CHIP_BANK               (0x3 << 0)		/* 8 bank */
#define CHIP_ROW				(0x3 << 4)		/* 15 row addr */

#define CHIP_COL                (0x3 << 8)  	/* 10 col addr */
#define CHIP_MAP    			(0x1 << 12)		/* Interleaved */
#define CHIP_MASK               (0x80 << 16)	/* 1GB */
#define CHIP0_BASE              (0x40 << 24)	// 0x40000000
#define CHIP1_BASE              (0x80 << 24)	// 0x80000000
